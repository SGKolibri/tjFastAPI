...
__export(item_controller_exports, {
  assignItemToObraHandler: () => assignItemToObraHandler,
  deleteItemHandler: () => deleteItemHandler,
  getItemHandler: () => getItemHandler,
  getItemsByObraHandler: () => getItemsByObraHandler,
  getItemsHandler: () => getItemsHandler,
  getObrasByItemHandler: () => getObrasByItemHandler,
  registerItemHandler: () => registerItemHandler,
  removeItemFromObraHandler: () => removeItemFromObraHandler,
  updateItemHandler: () => updateItemHandler,
  updateItemInObraHandler: () => updateItemInObraHandler
});
